...
cd $SLURM_SUBMIT_DIR
. /g100_scratch/userexternal/camadio0/ARGOPY_TESTS/Climatologies_Argopy/utils/profile.inc
...
OUTDIR=/g100_scratch/userexternal/camadio0/ARGOPY_TESTS/Climatologies_Argopy/bitsea_complement/CLIMATOLOGIES/SUPERFLOAT/
...
#for VARNAME in N3n pH N1p DIC N5s ALK O2o; do
