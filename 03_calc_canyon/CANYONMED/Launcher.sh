...
INPUTDIR=/g100_scratch/userexternal/camadio0/Tracing_deoxygenation_Med/ONLINE/SUPERFLOAT/
OUTDIR=/g100_scratch/userexternal/camadio0/Tracing_deoxygenation_Med/ONLINE/CANYON_MED_QC/
mkdir -p $OUTDIR
